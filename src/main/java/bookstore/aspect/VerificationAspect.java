...
import bookstore.annotation.Nullable;
import bookstore.exception.ParameterException;
...
public class VerificationAspect {
     ...
     */
    @Pointcut("execution(public * bookstore.controller.*.*Controller.*(..))")
