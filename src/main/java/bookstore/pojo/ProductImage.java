...
import bookstore.pojo.extension.ProductImageExtension;

public class ProductImage extends ProductImageExtension implements bookstore.pojo.ORM.POJOMapper<ProductImageMapper> {
    /**
     *
