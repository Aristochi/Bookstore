...
import bookstore.pojo.extension.CategoryExtension;

public class Category extends CategoryExtension implements bookstore.pojo.ORM.POJOMapper<CategoryMapper> {
    /**
	 * 
	 */
