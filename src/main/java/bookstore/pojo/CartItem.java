...
import bookstore.pojo.extension.CartItemExtension;

public class CartItem extends CartItemExtension implements bookstore.pojo.ORM.POJOMapper<CartItemMapper> {
    /**
     *
