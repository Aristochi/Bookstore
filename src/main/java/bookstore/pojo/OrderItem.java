...
import bookstore.pojo.extension.OrderItemExtension;

public class OrderItem extends OrderItemExtension implements bookstore.pojo.ORM.POJOMapper<OrderItemMapper> {
    /**
     *
