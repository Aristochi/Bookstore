...
import bookstore.pojo.extension.PropertyValueExtension;

public class PropertyValue extends PropertyValueExtension implements bookstore.pojo.ORM.POJOMapper<PropertyValueMapper> {
    /**
     *
