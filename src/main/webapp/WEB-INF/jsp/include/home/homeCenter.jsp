    ...
    <div data-ride="carousel" class="carousel-of-product carousel slide" id="carousel-of-product" >
        ...
        <div role="listbox" class="carousel-inner">
            <div class="item active">
                <a href="/bookstore/product?id=27" target="_blank">
                <img src="img/1.jpg" class="carousel carousel-image">
                </a>
            </div>
            <div class="item">
                <a href="/bookstore/product?id=1" target="_blank">
                <img src="img/2.jpg" class="carousel-image">
                </a>
            </div>
            <div class="item">
                <a href="/bookstore/product?id=20" target="_blank">
                <img src="img/3.jpg" class="carousel-image">
                </a>
            </div>
            <div class="item">
                <a href="/bookstore/product?id=30" target="_blank">
